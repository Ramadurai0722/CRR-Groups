          ...
          <div className="row align-items-center hero-v2-content">
            ...
            <div className="col-lg-6">
              <div className="hero-v2-image-wrapper">
                ...
                <Image src="/media/Home/Hero.webp" alt="CRR Groups professional electricians and plumbers" className="hero-v2-img" width={600} height={600} priority={true} fetchPriority="high" sizes="(max-width: 768px) 100vw, 50vw" />
